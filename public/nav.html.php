<nav class="navbar navbar-expand-lg <?= $css ?? "" ?>">
    <div class="container-fluid">
        <button class="navbar-toggler btn-hamburger" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-child">
                            <ul class="dropdown-menu drop-nav bg-dark">
                                <li>
                                    <a href="{{ path('app_info_utilisateur') }}"
                                        class="nav-link text-warning dropdown-item p-2">Informations personnelles</a>
                                </li>
                                <li>
                                    <a class="nav-link text-warning dropdown-item p-2"
                                        href="{{ path('app_historique_commandes') }}">Historique des commandes</a>
                                </li>
