...
<form method="post">
    ...
    <div class="form-group mt-3">
        <label for="surname">Pseudo
            <sup>*</sup>
        </label>
        <input type="text" name="surname" id="surname" class="form-control" value="<?= $user->getSurname() ?>" <?= $mode == "suppression" ? "disabled" : "" ?> required>
    </div>
    ...
    <div class="form-group mt-3">
        ...
        <input type="text" name="phone" id="phone" class="form-control" value="<?= $user->getPhone() ?>" <?= $mode == "suppression" ? "disabled" : "" ?>>
    </div>
